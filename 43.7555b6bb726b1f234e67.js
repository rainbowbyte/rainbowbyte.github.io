...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/dist/templateLoader.js??ref--6!./node_modules/vue-loader/dist??ref--2-0!./website/md-loader!./website/docs/message.md?vue&type=template&id=d8a9dbae

var messagevue_type_template_id_d8a9dbae_hoisted_1 = {
  class: "content element-doc"
};

var messagevue_type_template_id_d8a9dbae_hoisted_2 = /*#__PURE__*/Object(vue_esm_browser["o" /* createVNode */])("h2", {
...
var messagevue_type_template_id_d8a9dbae_hoisted_3 = /*#__PURE__*/Object(vue_esm_browser["o" /* createVNode */])("p", null, "常用于主动操作后的反馈提示。与 Notification 的区别是后者更多用于系统级通知的被动提醒。", -1);

var messagevue_type_template_id_d8a9dbae_hoisted_4 = /*#__PURE__*/Object(vue_esm_browser["o" /* createVNode */])("h3", {
  id: "ji-chu-yong-fa"
}, [/*#__PURE__*/Object(vue_esm_browser["o" /* createVNode */])("a", {
  class: "header-anchor",
  href: "#ji-chu-yong-fa"
...
var _hoisted_6 = /*#__PURE__*/Object(vue_esm_browser["o" /* createVNode */])("div", null, [/*#__PURE__*/Object(vue_esm_browser["o" /* createVNode */])("p", null, [/*#__PURE__*/Object(vue_esm_browser["n" /* createTextVNode */])("Message 在配置上与 Notification 非常类似，所以部分 options 在此不做详尽解释，文末有 options 列表，可以结合 Notification 的文档理解它们。Rainbowbyte UI 注册了一个"), /*#__PURE__*/Object(vue_esm_browser["o" /* createVNode */])("code", null, "$message"), /*#__PURE__*/Object(vue_esm_browser["n" /* createTextVNode */])("方法用于调用，Message 可以接收一个字符串或一个 VNode 作为参数，它会被显示为正文内容。")])], -1);

var _hoisted_7 = /*#__PURE__*/Object(vue_esm_browser["o" /* createVNode */])("pre", null, [/*#__PURE__*/Object(vue_esm_browser["o" /* createVNode */])("code", {
  class: "html"
}, "<template>\n  <ru-button :plain=\"true\" @click=\"open\">打开消息提示</ru-button>\n  <ru-button :plain=\"true\" @click=\"openVn\">VNode</ru-button>\n</template>\n\n<script>\n  import { defineComponent, h } from 'vue'\n  import { RuMessage } from 'rainbowbyte-ui'\n  export default defineComponent ({\n    setup() {\n      return {\n        open() {\n            RuMessage('只是一条消息提示')\n        },\n        openVn() {\n            RuMessage({\n            message: h('p', null, [\n              h('span', null, '内容可以是 '),\n              h('i', { style: 'color: teal' }, 'VNode')\n            ])\n          });\n        }\n      }\n    }\n  })\n</script>\n")], -1);
...
var _hoisted_11 = /*#__PURE__*/Object(vue_esm_browser["o" /* createVNode */])("pre", null, [/*#__PURE__*/Object(vue_esm_browser["o" /* createVNode */])("code", {
  class: "html"
}, "<template>\n  <ru-button :plain=\"true\" @click=\"open1\">成功</ru-button>\n  <ru-button :plain=\"true\" @click=\"open2\">警告</ru-button>\n  <ru-button :plain=\"true\" @click=\"open3\">消息</ru-button>\n  <ru-button :plain=\"true\" @click=\"open4\">错误</ru-button>\n</template>\n\n<script>\n  import { defineComponent } from 'vue'\n  import { RuMessage } from 'rainbowbyte-ui'\n  export default defineComponent({\n    setup() {\n      return {\n        open1() {\n          RuMessage.success({\n            message: '恭喜你，这是一条成功消息',\n            type: 'success'\n          });\n        },\n        open2() {\n          RuMessage.warning({\n            message: '警告哦，这是一条警告消息',\n            type: 'warning'\n          });\n        },\n        open3() {\n          RuMessage('这是一条消息提示');\n        },\n        open4() {\n          RuMessage.error('错了哦，这是一条错误消息');\n        }\n      }\n    }\n  })\n</script>\n")], -1);
...
var _hoisted_15 = /*#__PURE__*/Object(vue_esm_browser["o" /* createVNode */])("pre", null, [/*#__PURE__*/Object(vue_esm_browser["o" /* createVNode */])("code", {
  class: "html"
}, "<template>\n  <ru-button :plain=\"true\" @click=\"open1\">消息</ru-button>\n  <ru-button :plain=\"true\" @click=\"open2\">成功</ru-button>\n  <ru-button :plain=\"true\" @click=\"open3\">警告</ru-button>\n  <ru-button :plain=\"true\" @click=\"open4\">错误</ru-button>\n</template>\n\n<script>\n  import { defineComponent } from 'vue'\n  import { RuMessage } from 'rainbowbyte-ui'\n\n  export default defineComponent({\n    setup() {\n      return {\n        open1() {\n          RuMessage({\n            showClose: true,\n            message: '这是一条消息提示'\n          });\n        },\n\n        open2() {\n          RuMessage({\n            showClose: true,\n            message: '恭喜你，这是一条成功消息',\n            type: 'success'\n          });\n        },\n\n        open3() {\n          RuMessage({\n            showClose: true,\n            message: '警告哦，这是一条警告消息',\n            type: 'warning'\n          });\n        },\n\n        open4() {\n          RuMessage({\n            showClose: true,\n            message: '错了哦，这是一条错误消息',\n            type: 'error'\n          });\n        }\n      }\n    }\n  })\n</script>\n")], -1);
...
var _hoisted_18 = /*#__PURE__*/Object(vue_esm_browser["o" /* createVNode */])("pre", null, [/*#__PURE__*/Object(vue_esm_browser["o" /* createVNode */])("code", {
  class: "html"
}, "<template>\n  <ru-button :plain=\"true\" @click=\"openCenter\">文字居中</ru-button>\n</template>\n\n<script>\n  import { defineComponent } from 'vue'\n  import { RuMessage } from 'rainbowbyte-ui'\n  export default defineComponent({\n    setup() {\n      return {\n        openCenter() {\n          RuMessage({\n            message: '居中的文字',\n            center: true\n          });\n        }\n      }\n    }\n  })\n</script>\n")], -1);
...
function messagevue_type_template_id_d8a9dbae_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return Object(vue_esm_browser["F" /* openBlock */])(), Object(vue_esm_browser["j" /* createBlock */])("section", messagevue_type_template_id_d8a9dbae_hoisted_1, [messagevue_type_template_id_d8a9dbae_hoisted_2, messagevue_type_template_id_d8a9dbae_hoisted_3, messagevue_type_template_id_d8a9dbae_hoisted_4, _hoisted_5, Object(vue_esm_browser["o" /* createVNode */])(_component_demo_block, null, {
...
// CONCATENATED MODULE: ./website/docs/message.md?vue&type=template&id=d8a9dbae

// EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/extends.js
var helpers_extends = __webpack_require__(8);
var extends_default = /*#__PURE__*/__webpack_require__.n(helpers_extends);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/dist??ref--2-0!./website/md-loader!./website/docs/message.md?vue&type=script&lang=ts
  ...
  components: {
    "element-demo0": function () {
      ...
      var defineComponent = vue_esm_browser["p" /* defineComponent */],
          h = vue_esm_browser["r" /* h */];

      var _require = __webpack_require__(28),
          RuMessage = _require.RuMessage;
...
// CONCATENATED MODULE: ./website/docs/message.md?vue&type=script&lang=ts
 
// CONCATENATED MODULE: ./website/docs/message.md



messagevue_type_script_lang_ts.render = messagevue_type_template_id_d8a9dbae_render
