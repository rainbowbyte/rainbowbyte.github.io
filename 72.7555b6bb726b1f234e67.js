...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/dist/templateLoader.js??ref--6!./node_modules/vue-loader/dist??ref--2-0!./website/md-loader!./website/docs/upload.md?vue&type=template&id=4ce750e3

var uploadvue_type_template_id_4ce750e3_hoisted_1 = {
  class: "content element-doc"
};

var uploadvue_type_template_id_4ce750e3_hoisted_2 = /*#__PURE__*/Object(vue_esm_browser["o" /* createVNode */])("h2", {
...
var uploadvue_type_template_id_4ce750e3_hoisted_3 = /*#__PURE__*/Object(vue_esm_browser["o" /* createVNode */])("p", null, "通过点击或者拖拽上传文件", -1);

var uploadvue_type_template_id_4ce750e3_hoisted_4 = /*#__PURE__*/Object(vue_esm_browser["o" /* createVNode */])("h3", {
...
var _hoisted_9 = /*#__PURE__*/Object(vue_esm_browser["o" /* createVNode */])("pre", null, [/*#__PURE__*/Object(vue_esm_browser["o" /* createVNode */])("code", {
  class: "html"
}, "<ru-upload\n  class=\"avatar-uploader\"\n  action=\"https://jsonplaceholder.typicode.com/posts/\"\n  :show-file-list=\"false\"\n  :on-success=\"handleAvatarSuccess\"\n  :before-upload=\"beforeAvatarUpload\"\n>\n  <img v-if=\"imageUrl\" :src=\"imageUrl\" class=\"avatar\">\n  <i v-else class=\"ri-add-fill avatar-uploader-icon\" style=\"display: block\"></i>\n</ru-upload>\n\n<style>\n  .avatar-uploader .ru-upload {\n    border: 1px dashed #d9d9d9;\n    border-radius: 6px;\n    cursor: pointer;\n    position: relative;\n    overflow: hidden;\n  }\n  .avatar-uploader .ru-upload:hover {\n    border-color: #409EFF;\n  }\n  .avatar-uploader-icon {\n    font-size: 28px;\n    color: #8c939d;\n    width: 178px;\n    height: 178px;\n    line-height: 178px;\n    text-align: center;\n  }\n  .avatar {\n    width: 178px;\n    height: 178px;\n    display: block;\n  }\n</style>\n\n<script>\n  export default {\n    data() {\n      return {\n        imageUrl: ''\n      };\n    },\n    methods: {\n      handleAvatarSuccess(res, file) {\n        this.imageUrl = URL.createObjectURL(file.raw);\n      },\n      beforeAvatarUpload(file) {\n        const isJPG = file.type === 'image/jpeg';\n        const isLt2M = file.size / 1024 / 1024 < 2;\n\n        if (!isJPG) {\n          this.$message.error('上传头像图片只能是 JPG 格式!');\n        }\n        if (!isLt2M) {\n          this.$message.error('上传头像图片大小不能超过 2MB!');\n        }\n        return isJPG && isLt2M;\n      }\n    }\n  }\n</script>\n")], -1);
...
var _hoisted_15 = /*#__PURE__*/Object(vue_esm_browser["o" /* createVNode */])("pre", null, [/*#__PURE__*/Object(vue_esm_browser["o" /* createVNode */])("code", {
  class: "html"
}, "<ru-upload\n  action=\"#\"\n  list-type=\"picture-card\"\n  :auto-upload=\"false\">\n    <template #default>\n      <i class=\"ri-add-fill\"></i>\n    </template>\n    <template #file=\"{file}\">\n      <div>\n        <img class=\"ru-upload-list__item-thumbnail\" :src=\"file.url\" alt=\"\" />\n        <span class=\"ru-upload-list__item-actions\">\n          <span\n            class=\"ru-upload-list__item-preview\"\n            @click=\"handlePictureCardPreview(file)\"\n          >\n            <i class=\"ru-icon-zoom-in\"></i>\n          </span>\n          <span\n            v-if=\"!disabled\"\n            class=\"ru-upload-list__item-delete\"\n            @click=\"handleDownload(file)\"\n          >\n            <i class=\"ru-icon-download\"></i>\n          </span>\n          <span\n            v-if=\"!disabled\"\n            class=\"ru-upload-list__item-delete\"\n            @click=\"handleRemove(file)\"\n          >\n            <i class=\"ru-icon-delete\"></i>\n          </span>\n        </span>\n      </div>\n    </template>\n</ru-upload>\n<ru-dialog v-model=\"dialogVisible\">\n  <img width=\"100%\" :src=\"dialogImageUrl\" alt=\"\">\n</ru-dialog>\n<script>\n  export default {\n    data() {\n      return {\n        dialogImageUrl: '',\n        dialogVisible: false,\n        disabled: false\n      };\n    },\n    methods: {\n      handleRemove(file) {\n        console.log(file);\n      },\n      handlePictureCardPreview(file) {\n        this.dialogImageUrl = file.url;\n        this.dialogVisible = true;\n      },\n      handleDownload(file) {\n        console.log(file);\n      }\n    }\n  }\n</script>\n")], -1);
...
var _hoisted_17 = /*#__PURE__*/Object(vue_esm_browser["o" /* createVNode */])("pre", null, [/*#__PURE__*/Object(vue_esm_browser["o" /* createVNode */])("code", {
  class: "html"
}, "<ru-upload\n  class=\"upload-demo\"\n  action=\"https://jsonplaceholder.typicode.com/posts/\"\n  :on-preview=\"handlePreview\"\n  :on-remove=\"handleRemove\"\n  :file-list=\"fileList\"\n  list-type=\"picture\">\n  <ru-button size=\"small\" type=\"primary\">点击上传</ru-button>\n  <template #tip>\n    <div class=\"ru-upload__tip\">\n      只能上传 jpg/png 文件，且不超过 500kb\n    </div>\n  </template>\n</ru-upload>\n<script>\n  export default {\n    data() {\n      return {\n        fileList: [{name: 'food.jpg', url: 'https://asset.rainbowbyte.com/images/202105091620538613422vTX1Pw.jpg'}, {name: 'food2.jpg', url: 'https://asset.rainbowbyte.com/images/202105091620538611629ZmI28s.jpg'}]\n      };\n    },\n    methods: {\n      handleRemove(file, fileList) {\n        console.log(file, fileList);\n      },\n      handlePreview(file) {\n        console.log(file);\n      }\n    }\n  }\n</script>\n")], -1);
...
var _hoisted_20 = /*#__PURE__*/Object(vue_esm_browser["o" /* createVNode */])("pre", null, [/*#__PURE__*/Object(vue_esm_browser["o" /* createVNode */])("code", {
  class: "html"
}, "<ru-upload\n  class=\"upload-demo\"\n  action=\"https://jsonplaceholder.typicode.com/posts/\"\n  :on-change=\"handleChange\"\n  :file-list=\"fileList\">\n  <ru-button size=\"small\" type=\"primary\">点击上传</ru-button>\n  <template #tip>\n    <div class=\"ru-upload__tip\">\n      只能上传 jpg/png 文件，且不超过 500kb\n    </div>\n  </template>\n</ru-upload>\n<script>\n  export default {\n    data() {\n      return {\n        fileList: [{\n          name: 'food.jpg',\n          url: 'https://asset.rainbowbyte.com/images/202105091620538611629ZmI28s.jpg'\n        }, {\n          name: 'food2.jpg',\n          url: 'https://asset.rainbowbyte.com/images/202105091620538613422vTX1Pw.jpg'\n        }]\n      };\n    },\n    methods: {\n      handleChange(file, fileList) {\n        this.fileList = fileList.slice(-3);\n      }\n    }\n  }\n</script>\n")], -1);
...
var _hoisted_22 = /*#__PURE__*/Object(vue_esm_browser["o" /* createVNode */])("pre", null, [/*#__PURE__*/Object(vue_esm_browser["o" /* createVNode */])("code", {
  class: "html"
}, "<ru-upload\n  class=\"upload-demo\"\n  drag\n  action=\"https://jsonplaceholder.typicode.com/posts/\"\n  multiple>\n  <i class=\"ri-upload-cloud-fill\"></i>\n  <div class=\"ru-upload__text\">将文件拖到此处，或<em>点击上传</em></div>\n  <template #tip>\n    <div class=\"ru-upload__tip\">\n      只能上传 jpg/png 文件，且不超过 500kb\n    </div>\n  </template>\n</ru-upload>\n")], -1);
...
var _hoisted_24 = /*#__PURE__*/Object(vue_esm_browser["o" /* createVNode */])("pre", null, [/*#__PURE__*/Object(vue_esm_browser["o" /* createVNode */])("code", {
  class: "html"
}, "<ru-upload\n  class=\"upload-demo\"\n  ref=\"upload\"\n  action=\"https://jsonplaceholder.typicode.com/posts/\"\n  :on-preview=\"handlePreview\"\n  :on-remove=\"handleRemove\"\n  :file-list=\"fileList\"\n  :auto-upload=\"false\">\n  <template #trigger>\n    <ru-button size=\"small\" type=\"primary\">选取文件</ru-button>\n  </template>\n  <ru-button style=\"margin-left: 10px;\" size=\"small\" type=\"success\" @click=\"submitUpload\">上传到服务器</ru-button>\n  <template #tip>\n    <div class=\"ru-upload__tip\">\n      只能上传 jpg/png 文件，且不超过 500kb\n    </div>\n  </template>\n</ru-upload>\n<script>\n  export default {\n    data() {\n      return {\n        fileList: [{name: 'food.jpg', url: 'https://asset.rainbowbyte.com/images/202105091620538613422vTX1Pw.jpg'}, {name: 'food2.jpg', url: 'https://asset.rainbowbyte.com/images/202105091620538611629ZmI28s.jpg'}]\n      };\n    },\n    methods: {\n      submitUpload() {\n        this.$refs.upload.submit();\n      },\n      handleRemove(file, fileList) {\n        console.log(file, fileList);\n      },\n      handlePreview(file) {\n        console.log(file);\n      }\n    }\n  }\n</script>\n")], -1);
...
function uploadvue_type_template_id_4ce750e3_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return Object(vue_esm_browser["F" /* openBlock */])(), Object(vue_esm_browser["j" /* createBlock */])("section", uploadvue_type_template_id_4ce750e3_hoisted_1, [uploadvue_type_template_id_4ce750e3_hoisted_2, uploadvue_type_template_id_4ce750e3_hoisted_3, uploadvue_type_template_id_4ce750e3_hoisted_4, Object(vue_esm_browser["o" /* createVNode */])(_component_demo_block, null, {
    ...
    default: Object(vue_esm_browser["cb" /* withCtx */])(function () {
      return [uploadvue_type_template_id_4ce750e3_hoisted_5];
    }),
    _: 1
...
// CONCATENATED MODULE: ./website/docs/upload.md?vue&type=template&id=4ce750e3

// EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/extends.js
var helpers_extends = __webpack_require__(8);
var extends_default = /*#__PURE__*/__webpack_require__.n(helpers_extends);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/dist??ref--2-0!./website/md-loader!./website/docs/upload.md?vue&type=script&lang=ts
  ...
  components: {
    "element-demo0": function () {
      ...
      var _hoisted_2 = /*#__PURE__*/_createVNode("div", {
        class: "ru-upload__tip"
      }, "只能上传 jpg/png 文件，且不超过 500kb", -1);

      function render(_ctx, _cache) {
        var _component_ru_button = _resolveComponent("ru-button");

        var _component_ru_upload = _resolveComponent("ru-upload");

        return _openBlock(), _createBlock("div", null, [_createVNode(_component_ru_upload, {
          class: "upload-demo",
          action: "https://jsonplaceholder.typicode.com/posts/",
    ...
    "element-demo1": function () {
      var _openBlock = vue_esm_browser["F" /* openBlock */],
          _createBlock = vue_esm_browser["j" /* createBlock */],
      ...
      var _hoisted_1 = {
        key: 1,
        class: "ri-add-fill avatar-uploader-icon",
        style: {
          "display": "block"
        }
      };
    ...
    "element-demo2": function () {
      ...
      function render(_ctx, _cache) {
        ...
        return _openBlock(), _createBlock("div", null, [_createVNode(_component_ru_upload, {
          ...
          _: 1
        }, 8, ["on-preview", "on-remove"]), _createVNode(_component_ru_dialog, {
        ...
        return _openBlock(), _createBlock("div", null, [_createVNode(_component_ru_upload, {
          ...
          file: _withCtx(function (_ref) {
            ...
            return [_createVNode("div", null, [_createVNode("img", {
              class: "ru-upload-list__item-thumbnail",
              src: file.url,
              alt: ""
...
// CONCATENATED MODULE: ./website/docs/upload.md?vue&type=script&lang=ts
 
// CONCATENATED MODULE: ./website/docs/upload.md



uploadvue_type_script_lang_ts.render = uploadvue_type_template_id_4ce750e3_render
